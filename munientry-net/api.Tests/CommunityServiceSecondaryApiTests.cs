...
{
    public class CommunityServiceSecondaryApiTests : IClassFixture<MuniEntryWebApplicationFactory>
    {
        private readonly MuniEntryWebApplicationFactory _factory;

        public CommunityServiceSecondaryApiTests(MuniEntryWebApplicationFactory factory)
        {
            _factory = factory;
        }
