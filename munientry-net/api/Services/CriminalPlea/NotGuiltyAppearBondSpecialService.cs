...
public class NotGuiltyAppearBondSpecialService : DocxServiceBase<NotGuiltyAppearBondSpecialDto>, INotGuiltyAppearBondSpecialService
{
    protected override string TemplatePath { get; } =
        TemplateResolver.Get("Not_Guilty_Bond_Template.docx");

    protected override Dictionary<string, object> BuildTokens(NotGuiltyAppearBondSpecialDto dto) => new()
    {
