...
public class PleaOnlyFutureSentencingService : DocxServiceBase<PleaOnlyFutureSentencingDto>, IPleaOnlyFutureSentencingService
{
    protected override string TemplatePath { get; } =
        TemplateResolver.Get("Plea_Only_Template.docx");

    protected override Dictionary<string, object> BuildTokens(PleaOnlyFutureSentencingDto dto) => new()
    {
