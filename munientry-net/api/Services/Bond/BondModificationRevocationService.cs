...
public class BondModificationRevocationService : DocxServiceBase<BondModificationRevocationDto>, IBondModificationRevocationService
{
    protected override string TemplatePath { get; } =
        TemplateResolver.Get("Bond_Hearing_Template.docx");

    protected override Dictionary<string, object> BuildTokens(BondModificationRevocationDto dto) => new()
    {
