...
public class LeapAdmissionPleaService : DocxServiceBase<LeapAdmissionPleaDto>, ILeapAdmissionPleaService
{
    protected override string TemplatePath { get; } =
        TemplateResolver.Get("Leap_Admission_Plea_Template.docx");

    protected override Dictionary<string, object> BuildTokens(LeapAdmissionPleaDto dto) => new()
    {
