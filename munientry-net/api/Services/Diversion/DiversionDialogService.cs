...
public class DiversionDialogService : DocxServiceBase<DiversionDialogDto>, IDiversionDialogService
{
    protected override string TemplatePath { get; } =
        TemplateResolver.Get("Diversion_Template.docx");

    protected override Dictionary<string, object> BuildTokens(DiversionDialogDto dto) => new()
    {
